...
class AddListingShop extends StatefulWidget{
  ...
  @override
  State<AddListingShop> createState() => _AddListingShopState();
}
...
class _AddListingShopState extends State<AddListingShop> {
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Container(
                              child: Row(
                                children: storageRoom.map(
                                        (status){
                                      return Row(
                                        children: [
                                          Radio<String>(
                                            value: status.value,
                                            groupValue: _storageRoom,
                                            onChanged: (String? value) {
                                              setState(() {
                                                _storageRoom = value!;
                                              });
