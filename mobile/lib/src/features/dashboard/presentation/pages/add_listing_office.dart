...
class _AddListingOfficeState extends State<AddListingOffice> {
  ...
  List<RadioItem> officeTypes=[RadioItem(name: 'Open Plan', value: 'Open Plan'),RadioItem(name: 'Individual offices', value: 'Individual offices')];
  List<RadioItem> meetingRoom=[RadioItem(name: 'Yes', value: 'Yes'),RadioItem(name: 'No', value: 'No')];
  List<RadioItem> receptionArea=[RadioItem(name: 'Yes', value: 'Yes'),RadioItem(name: 'No', value: 'No')];
